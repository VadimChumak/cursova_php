    ...
    <div class="row" id="content">
        <div class="col l2 m3 hide-on-small-and-down z-depth-4" id="left-menu">
            ...
            <div class="collection user-menu" id="user-menu">
                ...
                <?php endif; ?>
                <a href="/groups/list/<?php echo $UserInfo['user_id']; ?>" class="collection-item waves-effect waves-light"><span class="badge">45</span>Groups</a>
                <a href="/photo/list/<?php echo $UserInfo['user_id']; ?>" class="collection-item waves-effect waves-light"><span class="badge">874</span>Photo</a>
                <a href="/music/list/<?php echo $UserInfo['user_id']; ?>" class="collection-item waves-effect waves-light"><span class="badge">9</span>Music</a>
                <a href="/video/list/<?php echo $UserInfo['user_id']; ?>" class="collection-item waves-effect waves-light"><span class="badge">12</span>Video</a>
            </div>
        </div>
